$(function() {
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            var pro=null;
            pro = eval("("+data+")");
            document.getElementById("useraccount").innerHTML=("ID："+pro.id);
            document.getElementById("username").innerHTML=("姓名："+pro.name);
            document.getElementById("userhosname").innerHTML=("所属医院："+pro.hos);
            // BJUI.navtab({
            //     id: pro.mainPageId,
            //     url: pro.mainPageUrl,
            //     title: pro.mainPageTitle,
            // });
        }
    });
    $("#info_board").load("major_function.html");
});
