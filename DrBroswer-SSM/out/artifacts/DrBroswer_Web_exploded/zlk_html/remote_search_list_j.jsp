...
<div class="bjui-pageContent">
    <table class="table table-bordered" id="datagrid-test-filter" data-toggle="datagrid" data-options="{
            ...
            gridTitle : '患者信息',
            showToolbar: false,
            dataUrl: '/remote/getReportListByCondition?modality=${param.modality}&pat_type=${param.pat_type}&dateBegin=${param.dateBegin}&dateEnd=${param.dateEnd}&name=${param.name}&ID=${param.ID}&number=${param.number}&clinic_id=${param.clinic_id}',
            dataType: 'json',
            jsonPrefix: 'obj',
            paging: {pageSize:60},
