...
<div class="bjui-pageContent">
    <div id="image">
        <img id="reportImage" src="/remote/${param.check_number}/<%=randomNum%>/loadReportImage"></img>
    </div>
</div>
<div class="bjui-pageFooter">
    ...
    <a hidden id="download_report" href="/remote/${param.check_number}/<%=randomNum%>/loadReportImage" download="${param.check_number}.jpg">下载</a>
</div>
</body>
</html>
